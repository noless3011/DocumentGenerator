    ...
    useEffect(() => {
        const loadPreviewApp = async () => {
            ...
            try {
                ...
                const response = await fetch(`http://localhost:5000/preview/${project.id}`, {
                    method: 'GET',
                    headers: {
                        'Accept': 'text/html',
                    },
                ...
                if (response.ok) {
                    ...
                    setPreviewUrl(`http://localhost:5000/preview/${project.id}`);
                    setLoading(false);
                    return;
                }
                ...
                const generateResponse = await fetch('http://localhost:5000/api/generate-preview-app', {
                    method: 'POST',
                    headers: {
